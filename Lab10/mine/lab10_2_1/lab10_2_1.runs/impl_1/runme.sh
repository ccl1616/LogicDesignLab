...
HD_PWD='C:/Users/ChiaLing/Documents/lab10_2_1/lab10_2_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top10_2_1_together.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top10_2_1_together.tcl -notrace
