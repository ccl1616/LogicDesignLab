...
HD_PWD='C:/Users/ChiaLing/Documents/lab10_2_1/lab10_2_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top10_2_1_together.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top10_2_1_together.tcl
