...
# push button input
set_property PACKAGE_PIN T18 [get_ports {pbpause}]                        
    set_property IOSTANDARD LVCMOS33 [get_ports {pbpause}]
set_property PACKAGE_PIN T17 [get_ports {pbstart}]                        
    set_property IOSTANDARD LVCMOS33 [get_ports {pbstart}]
    
set_property PACKAGE_PIN U17 [get_ports {pbmin}]                        
    set_property IOSTANDARD LVCMOS33 [get_ports {pbmin}]
set_property PACKAGE_PIN W19 [get_ports {pbsec}]                        
    set_property IOSTANDARD LVCMOS33 [get_ports {pbsec}]
