...
// FSM
`define STW 3'd0
`define STW_COUNT 3'd1 
`define STW_PAUSE 3'd2
`define STW_SETTING 3'd3
`define UPCNT_STOP 3'd4
`define UPCNT_START 3'd5
`define UPCNT_LAP 3'd6